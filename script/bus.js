...
async function FetchData() {
    try {
        let res = await fetch(`http://travelweb-env.eba-mxu6vfyg.ap-south-1.elasticbeanstalk.com/Buses`)
        res = await res.json()
       // console.log(res)
        Bus(res)
    } catch (err) {
    ...
    data.forEach((product) => {
        ...
        Booknow.addEventListener("click", () => {
            ...
            if (routeId == null) {
                ...
                fetch(`http://travelweb-env.eba-mxu6vfyg.ap-south-1.elasticbeanstalk.com/bookBus/${customerId}/${routeId}/${product.busId}`, {
                    method: 'POST',
                    headers: {
...
goButton.addEventListener('click', () => {
    ...
    fetch('http://travelweb-env.eba-mxu6vfyg.ap-south-1.elasticbeanstalk.com/route', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function handleSearch() {
    ...
    if (searchTerm === "") {
        ...
        fetch(`http://travelweb-env.eba-mxu6vfyg.ap-south-1.elasticbeanstalk.com/searchBus/${encodeURIComponent(searchTerm)}`)
            .then(response => response.json())
            .then(searchResults => {
