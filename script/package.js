...
packageViewers[i].addEventListener("click", (e) => {
    ...
    e.preventDefault();
    //Couples
    fetch("http://travelweb-env.eba-mxu6vfyg.ap-south-1.elasticbeanstalk.com/Packages")
        .then((objectResponse) => {
             ...
             //   let Id = document.createElement("h4");
               ...
               // Id.textContent = product.packageId;
                ...
                Booknow.addEventListener("click", () => {
                    fetch(`http://travelweb-env.eba-mxu6vfyg.ap-south-1.elasticbeanstalk.com/bookPackage/${customerId}/${product.packageId}`, {
                        method: 'POST',
                        headers: {
