...
let api = `http://travelweb-env.eba-mxu6vfyg.ap-south-1.elasticbeanstalk.com/YourTicket/${customerId}`;
        ...
        button.addEventListener("click", () => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    data.splice(index, 1);
                    fetch(`http://travelweb-env.eba-mxu6vfyg.ap-south-1.elasticbeanstalk.com/DeleteTicket/${element.ticketId}`, {
                        method: "DELETE",
                        headers: {
