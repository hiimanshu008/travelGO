...
let api = `http://travelweb-env.eba-mxu6vfyg.ap-south-1.elasticbeanstalk.com/YourBookings/${customerId}`;
            ...
            button.addEventListener("click", () => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        data.splice(index, 1);
                        fetch(`http://travelweb-env.eba-mxu6vfyg.ap-south-1.elasticbeanstalk.com/DeleteHotelBooking/${element.bookingId}`, {
                            method: "DELETE",
                            headers: {
            ...
            button.addEventListener("click", () => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        data.splice(index, 1);
                        fetch(`http://travelweb-env.eba-mxu6vfyg.ap-south-1.elasticbeanstalk.com/DeletePackageBooking/${element.bookingId}`, {
                            method: "DELETE",
                            headers: {
                                "Content-Type": "application/json",
                            },
